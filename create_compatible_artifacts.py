"""
Create compatible model and preprocessor artifacts for the Diamond Price Predictor API
"""
...
print("Creating compatible model and preprocessor artifacts...")
...
print("\nNote: The API's CustomData class will handle encoding categorical features")
print("The preprocessor expects numerical data after categorical encoding")